...
import net.sourceforge.jeuclid.mathml.MathMLAlignGroupElement;
import net.sourceforge.jeuclid.mathml.MathMLAlignMarkElement;
...
import net.sourceforge.jeuclid.mathml.MathMLFencedElement;
